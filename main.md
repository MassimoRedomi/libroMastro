...
- ### [4.0 Funzioni in parallelo](#funzioni-in-parallelo)
  - [4.1 Memoria condivisa](#memoria-condivisa-work-in-progress)
    ...
    - [4.1.2 <0 aspetta](#0-aspetta)
    - [4.1.3 external resources](#external-resources)
    - [4.1.4 Lista Semafori e altri Dati Condivisi tra i threads:](#lista-semafori-e-altri-dati-condivisi-tra-i-threads)
- ### [5.0 Lettura Configurazione](#lettura-configurazione)
